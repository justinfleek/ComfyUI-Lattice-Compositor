"""
RIFE Frame Interpolation - Weyl Compositor Backend
...
logger = logging.getLogger("weyl.frame_interpolation")
...
try:
    ...
    @routes.get('/weyl/video/interpolation/models')
    ...
    @routes.get('/weyl/video/interpolation/attribution')
    ...
    @routes.post('/weyl/video/interpolation/pair')
    ...
    @routes.post('/weyl/video/interpolation/sequence')
    ...
    @routes.post('/weyl/video/interpolation/slowmo')
    ...
    logger.info("Weyl Frame Interpolation routes registered")
...
if __name__ == "__main__":
    ...
    if args.models:
        ...
        print("Frame Interpolation - Weyl Compositor")
        print("=" * 50)
        print("\nAvailable models:")
