...
var choice = /* #__PURE__ */ StringParser_Combinators.choice(Data_List_Types.foldableList);
    ...
    return function (simpleExpr) {
        ...
        var splitOp = function (v) {
            return function (v1) {
                ...
                throw new Error("Failed pattern match at StringParser.Expr (line 62, column 5 - line 62, column 68): " + [ v.constructor.name, v1.constructor.name ]);
            };
        };
        ...
        var makeParser = function (term) {
            return function (ops) {
                ...
                var postfixOp = StringParser_Combinators.withError(choice(accum.postfix))("");
                var postfixP = alt(postfixOp)(pure(identity));
                var prefixOp = StringParser_Combinators.withError(choice(accum.prefix))("");
                var prefixP = alt(prefixOp)(pure(identity));
                var rassocOp = choice(accum.rassoc);
                return bind(termP(prefixP)(term)(postfixP))(function (x) {
                    return alt(rassocP(x)(rassocOp)(prefixP)(term)(postfixP))(alt(lassocP(x)(lassocOp)(prefixP)(term)(postfixP))(alt(nassocP(x)(nassocOp)(prefixP)(term)(postfixP))(StringParser_Combinators.withError(pure(x))("operator"))));
                });
            };
        };
