...
shgTable = V.fromList
  ...
  , 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23
  , 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24
...
mulTableValue radius
  | radius >= 0 && radius < V.length mulTable = mulTable ! radius
  | otherwise = 512
...
shgTableValue radius
  | radius >= 0 && radius < V.length shgTable = shgTable ! radius
  | otherwise = 24
...
--
--   @param sumVal Accumulated weighted sum
