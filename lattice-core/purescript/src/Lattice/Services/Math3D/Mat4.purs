...
module Lattice.Services.Math3D.Mat4
  ...
  , transformPoint, transformDirection, transformPoint4
    -- * Matrix Operations
...
import Data.Number (cos, sin, tan) as Math
...
-- | Transform a point returning all 4 components (for perspective divide)
transformPoint4 :: Mat4 -> Vec3 -> Vec4
transformPoint4 (Mat4 m) (Vec3 p) =
