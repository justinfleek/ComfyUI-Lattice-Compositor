            ...
            return function (opts) {
                return bind(opts.fetch(Data_Maybe.Nothing.value))(function (result) {
                    return pure((function () {
                        ...
                        throw new Error("Failed pattern match at Hydrogen.Query (line 570, column 10 - line 584, column 8): " + [ result.constructor.name ]);
                    })());
                });
            };
        };
            ...
            return function (currentTime) {
                return function (key) {
                    return function (entry) {
                        ...
                        throw new Error("Failed pattern match at Hydrogen.Query (line 505, column 3 - line 508, column 29): " + [ prefixStr.constructor.name, currentTime.constructor.name, key.constructor.name, entry.constructor.name ]);
                    };
                };
            };
        };
...
var foldData = function (handlers) {
    return function (state) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Query (line 705, column 27 - line 709, column 34): " + [ state.data.constructor.name ]);
    };
};
        ...
        return function (retriesLeft) {
            return function (retryDelay) {
                return bind(fetch)(function (result) {
                    ...
                    throw new Error("Failed pattern match at Hydrogen.Query (line 431, column 3 - line 436, column 32): " + [ result.constructor.name ]);
                });
            };
        };
    };
                    ...
                    if (nextCursor instanceof Data_Maybe.Just) {
                        return bind(opts.fetch(new Data_Maybe.Just(nextCursor.value0)))(function (result) {
                            return pure((function () {
                                ...
                                throw new Error("Failed pattern match at Hydrogen.Query (line 602, column 14 - line 612, column 14): " + [ result.constructor.name ]);
                            })());
                        });
                    };
                    throw new Error("Failed pattern match at Hydrogen.Query (line 598, column 3 - line 612, column 14): " + [ nextCursor.constructor.name ]);
                };
            };
        };
    };
                ...
                return function (staleData) {
                    ...
                    return bind(liftEffect(map1(lookup(cacheKey))(Effect_Ref.read(v.inFlight))))(function (inFlightFiber) {
                        return bind((function () {
                                        ...
                                        return bind(Effect_Aff.joinFiber(fiber))(function (result) {
                                            return discard(liftEffect(Effect_Ref.modify_($$delete(cacheKey))(v.inFlight)))(function () {
                                                return discard((function () {
                                                    ...
                                                    throw new Error("Failed pattern match at Hydrogen.Query (line 380, column 7 - line 387, column 28): " + [ result.constructor.name ]);
                                                })())(function () {
                                                    return pure(result);
                                                });
                                            });
                            ...
                            throw new Error("Failed pattern match at Hydrogen.Query (line 367, column 17 - line 389, column 18): " + [ inFlightFiber.constructor.name ]);
                        })())(function (jsonResult) {
                            return pure((function () {
                                if (jsonResult instanceof Data_Either.Left) {
                                    ...
                                    throw new Error("Failed pattern match at Hydrogen.Query (line 395, column 7 - line 407, column 12): " + [ staleData.constructor.name ]);
                                };
                                if (jsonResult instanceof Data_Either.Right) {
                                    ...
                                    throw new Error("Failed pattern match at Hydrogen.Query (line 409, column 7 - line 419, column 12): " + [ v1.constructor.name ]);
                                };
                                throw new Error("Failed pattern match at Hydrogen.Query (line 392, column 10 - line 419, column 12): " + [ jsonResult.constructor.name ]);
                            })());
                        });
                    });
                };
                    ...
                    return bind(liftEffect(Effect_Now.now))(function (currentTime) {
                        return bind(liftEffect(map1(lookup(cacheKey))(Effect_Ref.read(v.cache))))(function (cachedEntry) {
                            if (cachedEntry instanceof Data_Maybe.Just && !isEntryStale(cachedEntry.value0)(currentTime)) {
                                ...
                                throw new Error("Failed pattern match at Hydrogen.Query (line 336, column 7 - line 342, column 49): " + [ v3.constructor.name ]);
                            };
                            ...
                            throw new Error("Failed pattern match at Hydrogen.Query (line 333, column 3 - line 350, column 46): " + [ cachedEntry.constructor.name ]);
                        });
                    });
                };
            };
