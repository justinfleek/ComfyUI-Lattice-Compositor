...
import * as Test_Cache_Property from "../Test.Cache.Property/index.js";
import * as Test_ColorConversion from "../Test.ColorConversion/index.js";
import * as Test_ColorEdgeCases from "../Test.ColorEdgeCases/index.js";
import * as Test_Element from "../Test.Element/index.js";
import * as Test_Element_Property from "../Test.Element.Property/index.js";
import * as Test_GPU_Diffusion from "../Test.GPU.Diffusion/index.js";
import * as Test_Property from "../Test.Property/index.js";
import * as Test_QRCode from "../Test.QRCode/index.js";
import * as Test_Scene3D from "../Test.Scene3D/index.js";
import * as Test_Schema_Property from "../Test.Schema.Property/index.js";
import * as Test_Sensation_Property from "../Test.Sensation.Property/index.js";
...
import * as Test_Submodular_Property from "../Test.Submodular.Property/index.js";
import * as Test_WebGPU_Geometry from "../Test.WebGPU.Geometry/index.js";
import * as Test_Widget from "../Test.Widget/index.js";
...
var main = /* #__PURE__ */ Effect_Aff.launchAff_(/* #__PURE__ */ Test_Spec_Runner.runSpec()([ Test_Spec_Reporter_Console.consoleReporter ])(/* #__PURE__ */ discard1(/* #__PURE__ */ describe("Hydrogen Framework")(/* #__PURE__ */ discard1(formatTests)(function () {
    ...
    return discard1(describe("Render Abstraction")(Test_Element.elementTests))(function () {
        return discard1(describe("Property Tests")(Test_Property.propertyTests))(function () {
            return discard1(describe("Color System Tests")(discard1(Test_ColorConversion.colorConversionTests)(function () {
                return Test_ColorEdgeCases.colorEdgeCaseTests;
            })))(function () {
                return discard1(describe("QR Code Tests")(Test_QRCode.qrCodeTests))(function () {
                    return discard1(describe("Widget Tests")(Test_Widget.widgetPropertyTests))(function () {
                        return discard1(describe("Scene3D Tests")(Test_Scene3D.scene3DTests))(function () {
                            return discard1(describe("WebGPU Tests")(Test_WebGPU_Geometry.geometryTests))(function () {
                                return discard1(describe("FAA Submodular Allocation")(Test_Submodular_Property.spec))(function () {
                                    return discard1(describe("GPU Diffusion")(Test_GPU_Diffusion.diffusionPropertyTests))(function () {
                                        return discard1(describe("Schema")(Test_Schema_Property.schemaPropertyTests))(function () {
                                            return discard1(describe("Sensation \u2192 Rights")(Test_Sensation_Property.sensationPropertyTests))(function () {
                                                return discard1(describe("Cache Property Tests")(Test_Cache_Property.cachePropertyTests))(function () {
                                                    return describe("Element Property Tests")(Test_Element_Property.elementPropertyTests);
                                                });
                                            });
                                        });
                                    });
