...
var renderProp = function (v) {
    if (v instanceof Halogen_VDom_DOM_Prop.Attribute) {
        var prefix = (function () {
            ...
            throw new Error("Failed pattern match at Hydrogen.HTML.Renderer (line 153, column 18 - line 155, column 24): " + [ v.value0.constructor.name ]);
        })();
    ...
    throw new Error("Failed pattern match at Hydrogen.HTML.Renderer (line 151, column 14 - line 167, column 12): " + [ v.constructor.name ]);
};
...
var renderVDom = function ($copy_opts) {
    return function ($copy_v) {
        ...
        function $tco_loop(opts, v) {
            ...
            throw new Error("Failed pattern match at Hydrogen.HTML.Renderer (line 83, column 19 - line 93, column 44): " + [ v.constructor.name ]);
        };
        while (!$tco_done) {
            ...
            return function (props) {
                return function (children) {
                    ...
                    var nsAttr = (function () {
                        ...
                        throw new Error("Failed pattern match at Hydrogen.HTML.Renderer (line 108, column 14 - line 110, column 20): " + [ maybeNs.constructor.name ]);
                    })();
