...
var headers = function (config) {
    ...
    throw new Error("Failed pattern match at Hydrogen.API.Client (line 192, column 18 - line 197, column 6): " + [ config.authToken.constructor.name ]);
};
    ...
    return function (path) {
        ...
        return discard(logRequest(config)("DELETE")(url))(function () {
            return bind(Affjax_Web.request({
                ...
                throw new Error("Failed pattern match at Hydrogen.API.Client (line 142, column 3 - line 149, column 24): " + [ result.constructor.name ]);
            });
        });
    };
};
...
var decode = function (dictDecodeJson) {
    ...
    return function (json) {
        ...
        throw new Error("Failed pattern match at Hydrogen.API.Client (line 200, column 15 - line 202, column 25): " + [ v.constructor.name ]);
    };
};
                    ...
                    return function (maybeBody) {
                        ...
                        return discard(logRequest(config)(methodStr)(url))(function () {
                            return bind(Affjax_Web.request({
                                ...
                                throw new Error("Failed pattern match at Hydrogen.API.Client (line 178, column 3 - line 185, column 34): " + [ result.constructor.name ]);
                            });
                        });
                    };
                };
