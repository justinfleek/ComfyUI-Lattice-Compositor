...
var showWebSocketState = {
    show: function (v) {
        ...
        throw new Error("Failed pattern match at Hydrogen.Realtime.WebSocket (line 126, column 1 - line 130, column 25): " + [ v.constructor.name ]);
    }
};
var sendText = function (v) {
    return function (text) {
        return function __do() {
            ...
            throw new Error("Failed pattern match at Hydrogen.Realtime.WebSocket (line 292, column 3 - line 294, column 30): " + [ maybeWs.constructor.name ]);
        };
    };
};
    ...
    return function (code) {
        return function (reason) {
            return function __do() {
                ...
                throw new Error("Failed pattern match at Hydrogen.Realtime.WebSocket (line 272, column 3 - line 274, column 46): " + [ maybeWs.constructor.name ]);
            };
        };
    };
};
var close = function (v) {
    return function __do() {
        ...
        throw new Error("Failed pattern match at Hydrogen.Realtime.WebSocket (line 263, column 3 - line 265, column 26): " + [ maybeWs.constructor.name ]);
    };
};
export {
    Connecting,
