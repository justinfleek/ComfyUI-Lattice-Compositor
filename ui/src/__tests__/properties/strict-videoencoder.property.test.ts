...
describe('STRICT: WebCodecs Support Detection', () => {
  ...
  // Note: These tests may pass or fail depending on browser/environment
  test.skip('supported codecs include known codecs', async () => {
    const codecs = await getSupportedCodecs();
    
    // At least one codec should be supported in modern browsers
