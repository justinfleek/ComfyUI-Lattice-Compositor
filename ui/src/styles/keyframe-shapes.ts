...
export function createKeyframeSVG(
  ...
  const stroke = def.stroke ? `stroke="${color}" stroke-width="2" fill="none"` : `fill="${fill}"`;
...
export const KEYFRAME_SHAPE_LEGEND: Array<{
  ...
  { id: 'mini', name: 'Mini', description: 'Subtle/micro keyframes', easing: [] },
  { id: 'extend', name: 'Extend', description: 'Hold keyframe', easing: ['hold', 'step'] },
  { id: 'long', name: 'Long', description: 'Long duration marker', easing: [] },
  { id: 'roundHead', name: 'Round Head', description: 'Smooth start', easing: ['spring'] },
  { id: 'rhExtend', name: 'RH Extend', description: 'Smooth with hold', easing: [] },
  { id: 'rhLong', name: 'RH Long', description: 'Smooth with long hold', easing: [] },
  { id: 'rhOutline', name: 'RH Outline', description: 'Outline variant', easing: [] },
  { id: 'wide', name: 'Wide', description: 'Wide timing window', easing: [] },
  { id: 'wideHammer', name: 'Wide Hammer', description: 'Hard stop after wide', easing: [] },
  { id: 'pill', name: 'Pill', description: 'Eased transition', easing: ['easeInOut'] },
  { id: 'watch', name: 'Watch', description: 'Custom bezier curve', easing: ['bezier'] },
  { id: 'triangle', name: 'Triangle', description: 'Ease in (accelerating)', easing: ['easeIn'] },
  { id: 'diamond', name: 'Diamond', description: 'Linear (standard)', easing: ['linear'] },
  { id: 'martini', name: 'Martini', description: 'Ease out (decelerating)', easing: ['easeOut'] },
  { id: 'radio', name: 'Radio', description: 'Point keyframe', easing: ['bounce'] },
  { id: 'radioLong', name: 'Radio Long', description: 'Point with extension', easing: ['elastic'] },
];
