...
// Expression methods moved to ./keyframes/keyframeExpressions.ts
...
// Expression baking (convertExpressionToKeyframes, canBakeExpression) moved to
// ./keyframes/keyframeExpressions.ts - re-exported at top of file
