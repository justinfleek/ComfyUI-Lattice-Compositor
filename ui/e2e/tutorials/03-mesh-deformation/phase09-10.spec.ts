...
test.describe('Tutorial 03: Mesh Deformation - Phases 9-10 (Steps 116-145)', () => {
  ...
  test('Phase 9: Motion Recording (Steps 116-130)', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="motion-recording-active"]')).toBeVisible();
  ...
  test('Phase 10: Troubleshooting Common Issues (Steps 131-145)', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="mesh-warning"]')).not.toBeVisible();
