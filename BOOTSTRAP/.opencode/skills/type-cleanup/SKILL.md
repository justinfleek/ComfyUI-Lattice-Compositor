---
name: type-cleanup
description: Fix type issues by updating type definitions to match code, not vice versa. Use when working with types, type systems, typing, or fixing type errors.
license: MIT
