...
Haskell scripts instead of bash. `Straylight.Script` provides a type-safe shell scripting environment.
...
Source: `nix/scripts/Straylight/Script.hs`
...
```nix
pkgs.straylight.script.ghc           # GHC with Straylight.Script
