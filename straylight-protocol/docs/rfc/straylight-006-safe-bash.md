...
ℵ-004 (Straylight.Script) argues for replacing bash with typed Haskell. But we still use bash in places like:
...
- **ℵ-004 (Straylight.Script)**: Defines where logic goes (Haskell)
