# Contributing to Straylight-Naught
...
The membrane translates at boundaries. Inside straylight-naught, everything is `lisp-case`.

## Documentation

- **RFCs go in**: `docs/languages/nix/rfc/straylight-NNN-title.md`
- **Guides go in**: `docs/languages/nix/guides/`
- **Reference goes in**: `docs/languages/nix/reference/`

Use ℵ symbol in display text, `straylight-` in filenames:

```markdown
[ℵ-001](straylight-001-standard-nix.md)  ✓
...
- [ℵ-001](docs/languages/nix/rfc/straylight-001-standard-nix.md) — Code style
- [ℵ-004](docs/languages/nix/rfc/straylight-004-typed-unix.md) — Typed Unix architecture
- [ℵ-006](docs/languages/nix/rfc/straylight-006-safe-bash.md) — What counts as "safe" bash
