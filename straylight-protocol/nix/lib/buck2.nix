...
#
#   packages.myapp = straylight.lib.buck2.build pkgs {
#     src = ./.;
#     target = "//src:myapp";
#   };
#
...
in
{
  ...
  #
  # Usage:
  #   straylight.lib.buck2.build pkgs {
  #     src = ./.;
  ...
  build =
    ...
    let
      ...
      # Get prelude
      prelude = inputs.buck2-prelude or (throw "straylight.lib.buck2.build requires inputs.buck2-prelude");
