...
let
  cfg = config.straylight-naught.nativelink;
in
{
  _class = "flake";

  options.straylight-naught.nativelink = {
    ...
    registry = lib.mkOption {
      type = lib.types.str;
      default = "ghcr.io/straylight-software/straylight";
        ...
        mkDeployScript =
          ...
          pkgs.writeShellApplication {
            ...
            text = ''
              ...
              GHCR_IMAGE="ghcr.io/straylight-software/straylight/nativelink-${name}:latest"
