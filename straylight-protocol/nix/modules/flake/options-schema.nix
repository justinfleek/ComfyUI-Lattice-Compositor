...
#                                                         — Neuromancer
#
# Shared options schema for straylight-naught modules.
# Used by both the flake-parts modules and NDG documentation generation.
#
# This is the single source of truth for all straylight-naught option definitions.
#
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{ lib }:
{
  ...
  formatter = {
    enable = lib.mkEnableOption "straylight-naught formatter" // {
      default = true;
    };
  ...
  overlays = {
    enable = lib.mkEnableOption "straylight-naught overlays" // {
      default = true;
    };
    extra = lib.mkOption {
      type = lib.types.listOf lib.types.raw;
  ...
  devshell = {
    enable = lib.mkEnableOption "straylight-naught devshell";
