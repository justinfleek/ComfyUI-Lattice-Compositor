...
@
import Straylight.Script.Tools.CMake as CMake
...
When using straylight-naught's stdenv, compiler flags come from the Turing Registry
...
data Options = Options
    ...
    -- ^ CMAKE_BUILD_TYPE (usually leave Nothing for straylight-naught)
