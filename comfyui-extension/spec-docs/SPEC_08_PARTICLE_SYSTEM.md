...
This specification documents the complete state of Lattice's particle ecosystem including particles, point clouds, camera trajectories, and depth-based effects. The goal is production-grade software competitive with industry-standard motion graphics tools.
...
### vs Trapcode Particular (Industry Standard)
