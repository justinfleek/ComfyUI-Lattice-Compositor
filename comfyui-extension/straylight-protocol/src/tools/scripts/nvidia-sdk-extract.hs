...
This script uses the typed Straylight.Script infrastructure:
  - Straylight.Script.Tools.Crane for OCI image operations
  - Straylight.Script.Tools.Bwrap for FHS sandbox (installer mode)
  - Straylight.Script.Oci for container caching/environment
