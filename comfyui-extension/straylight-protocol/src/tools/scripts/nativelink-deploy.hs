...
Options:
  --registry URL   Container registry (default: ghcr.io/straylight-software/straylight)
...
defaultConfig = Config
    { cfgRegistry = "ghcr.io/straylight-software/straylight"
    , cfgRegion = "iad"
    , cfgDryRun = False
    , cfgComponent = All
    }
...
ensureCasVolume cfg = do
    ...
    volumes <- run "fly" ["volumes", "list", "-a", "straylight-cas", "--json"]
