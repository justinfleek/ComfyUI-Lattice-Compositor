...
{- |
Quick validation script for Straylight.Script tooling
...
import qualified Straylight.Script.Clap as Clap
import qualified Straylight.Script.Getopt as Getopt

main :: IO ()
main = do
    putStrLn "=== Straylight.Script Validation ==="
    putStrLn ""
    ...
    let testInput =
        ...
        checks =
            [ ("module", "module Straylight.Script.Tools.Test" `T.isInfixOf` generated)
