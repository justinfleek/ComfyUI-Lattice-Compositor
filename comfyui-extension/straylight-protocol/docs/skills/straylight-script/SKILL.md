...
## name: straylight-script description: Write Haskell scripts using straylight-std's Straylight.Script infrastructure (Straylight.Script, Dhall configs, Nix integration)

# Straylight Script — Straylight.Script

straylight-std uses Haskell scripts instead of bash for complex operations. The `Straylight.Script` module provides a batteries-included prelude combining:
...
## Straylight.Script API Reference
...
```haskell
-- nix/scripts/Straylight/Script/MyTool/Config.hs
{-# LANGUAGE DeriveGeneric #-}
module Straylight.Script.MyTool.Config where

import Straylight.Script.Config (StorePath(..), loadConfigFile)
...
-- nix/scripts/my-tool.hs
import Straylight.Script
import Straylight.Script.MyTool.Config
...
### Straylight.Script.Oci — Container Operations
...
### Straylight.Script.Vm — VM Operations
...
1. **Wrap external tools** in `Straylight/Script/Tools/` for reuse
