...
![lambda cube showing system straylight-naught below untyped lambda calculus](docs/lambda-hierarchy.svg)
...
```nix
{
  inputs.straylight.url = "github:straylight-software/nix";

  outputs = { straylight, ... }:
    straylight.lib.mkFlake {
...
| rfc | status |
|-----|--------|
| [001](docs/rfc/straylight-001-standard-nix.md) standard nix | implemented |
| [002](docs/rfc/straylight-002-lint.md) linting | implemented |
| [003](docs/rfc/straylight-003-prelude.md) the prelude | implemented |
| [004](docs/rfc/straylight-004-typed-unix.md) typed unix | implemented |
| [005](docs/rfc/straylight-005-profiles.md) nix profiles | implemented |
| [006](docs/rfc/straylight-006-safe-bash.md) safe bash | implemented |
| [007](docs/rfc/straylight-007-formalization.md) nix formalization | draft |
