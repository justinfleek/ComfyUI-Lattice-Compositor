...
#                                                         — Neuromancer
#
# Core straylight-naught module with overlays. This is the entry point that brings
...
in
{
  ...
  options.straylight-naught.overlays = {
  ...
  config.perSystem =
    ...
    lib.mkIf cfg.overlays.enable {
      ...
      #   inputs.straylight-naught.legacyPackages.${system}.straylight.prelude
