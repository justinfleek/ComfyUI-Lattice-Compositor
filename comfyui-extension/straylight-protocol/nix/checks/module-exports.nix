...
let
  ...
  test-shortlist-builds = pkgs.runCommand "test-shortlist-builds" { } ''
    ...
    echo "  3. Downstream flakes can use straylight.modules.flake.shortlist-standalone"
    echo ""
    echo "To use in a downstream flake:"
    echo "  imports = [ straylight.modules.flake.shortlist-standalone ];"
    echo "  straylight-naught.shortlist.enable = true;"
    echo ""
  ...
  test-module-full = pkgs.runCommand "test-module-full" { } ''
    ...
    echo "  imports = [ straylight.modules.flake.full ];"
    echo "  straylight-naught.build.enable = true;"
    echo "  straylight-naught.shortlist.enable = true;"
    echo "  straylight-naught.lre.enable = true;"
