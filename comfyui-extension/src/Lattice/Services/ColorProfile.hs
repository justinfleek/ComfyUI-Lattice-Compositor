...
sRGBToLinear value =
  let finiteValue = ensureFiniteD value 0.0
...
gammaToLinear value gamma =
  let finiteValue = if ensureFiniteD value 0.0 < 0.0 then 0.0 else ensureFiniteD value 0.0
      finiteGamma = ensureFiniteD gamma 2.2
...
matrixMultiply3x3 ((m00, m01, m02), (m10, m11, m12), (m20, m21, m22)) (v0, v1, v2) =
  ...
  in (ensureFiniteD r0 0.0, ensureFiniteD r1 0.0, ensureFiniteD r2 0.0)
