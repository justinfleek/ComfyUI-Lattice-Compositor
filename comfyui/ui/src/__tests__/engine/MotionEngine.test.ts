...
describe('STRICT: MotionEngine Edge Cases', () => {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // AUDIO EVALUATION (without actual audio)
  // ═══════════════════════════════════════════════════════════════════════════
  ...
  describe('PROPERTY: evaluation invariants', () => {
    // FIXED: Original test was misleading - opacity is only clamped with audio modifiers
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  //                        // camera // evaluation // critical // gap // filled
  // ═══════════════════════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  //                              // layer // specific // property // evaluation
  // ═══════════════════════════════════════════════════════════════════════════
