...
describe('EXPRESSION Properties', () => {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  //                                  // math // expressions // seeded // random
  // ═══════════════════════════════════════════════════════════════════════════
