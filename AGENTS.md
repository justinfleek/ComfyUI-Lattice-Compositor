...
### Literate Programming (STRAYLIGHT-011)
...
### Chat Templates & Thinking Blocks (Agent Voice)
- ❌ Agent code without chat template support → ERROR (STRAYLIGHT-CHAT-002)
- ❌ Agent responses without thinking block handling → ERROR (STRAYLIGHT-THINK-002)
- ✅ Chat templates must use Qwen3/ChatML format: `<|im_start|>role\ncontent<|im_end|>`
- ✅ Thinking blocks must be properly closed: `<think>...</think>`
- ✅ Agent code handling LLM responses must support extraction/stripping
- Reference: `STRAYLIGHT_STANDARDS.md` for complete specifications
...
- Reference: `ARCHITECTURE_IMPLEMENTATION.md` section 2
...
- Reference: `toolbox/core/db/reactive_cell.py`
...
- ✅ Proof comments required: System F/Omega, Type, Mathematical proofs
- ✅ Rich error messages - Include context, file names, exact values
- ✅ No lazy fixes - Zero shortcuts, zero simple fixes
- Reference: `LATTICE/docs/QUICK_START_FOR_NEW_CHAT.md` section "System F/Omega"

### Agent Training Pattern (Engram)
- ✅ Use engram pattern for O(1) lookup agent training data
- ✅ Location: `toolbox/core/memory/engram.py`
- ✅ Fast memory retrieval for agent context
