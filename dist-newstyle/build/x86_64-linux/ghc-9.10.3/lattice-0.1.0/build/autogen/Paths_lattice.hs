...
-- at runtime using the environment variable lattice_bindir.
...
-- environment variable lattice_libdir.
...
-- using the environment variable lattice_dynlibdir.
...
-- runtime using the environment variable lattice_datadir.
...
-- using the environment variable lattice_sysconfdir.
...
getDynLibDir  = catchIO (getEnv "lattice_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "lattice_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "lattice_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "lattice_sysconfdir") (\_ -> return sysconfdir)
