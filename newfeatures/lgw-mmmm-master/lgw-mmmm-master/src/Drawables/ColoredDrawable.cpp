...
void ColoredDrawable2D::draw(
    const Matrix3& transformationMatrix, SceneGraph::Camera2D& camera
) {
    (*m_shader.lock())
        .setColor(m_color)
