                       ...
                       double* alpha4)
{
    ...
    switch(k){
        ...
        case 2: // segment vs. triangle
            double test1,test2;
            test1 = orientation3d(x1, x2, x3, x4);
            test2 = orient3d(x1, x2, x3, x4);
            if (test1 > 0 && test2 < 0 || test1 < 0 && test2 > 0) {
                std::cout << "TEST MISMATCH!\n";
                std::getchar();
            }
//            *alpha0= orientation3d(x1, x2, x3, x4);
            *alpha0= orient3d(x1, x2, x3, x4);
            //*alpha0= orient3d_test(x1, x2, x3, x4);
            //*alpha1=-orientation3d(x0, x2, x3, x4);
            test1 = orientation3d(x0, x2, x3, x4);
            test2 = orient3d(x0, x2, x3, x4);
            if (test1 > 0 && test2 < 0 || test1 < 0 && test2 > 0) {
                std::cout << "TEST MISMATCH!\n";
                std::getchar();
            }
            *alpha1=-orient3d(x0, x2, x3, x4);
            if(!same_sign(*alpha0, *alpha1)) return 0;
            test1 = orientation3d(x0, x1, x3, x4);
            test2 = orient3d(x0, x1, x3, x4);
            if (test1 > 0 && test2 < 0 || test1 < 0 && test2 > 0) {
                std::cout << "TEST MISMATCH!\n";
                std::getchar();
            }
            *alpha2= orient3d(x0, x1, x3, x4);
            test1 = orientation3d(x0, x1, x2, x4);
            test2 = orient3d(x0, x1, x2, x4);
            if (test1 > 0 && test2 < 0 || test1 < 0 && test2 > 0) {
                std::cout << "TEST MISMATCH!\n";
                std::getchar();
            }
...
//                std::cout << "CURRENT COUNTER = " << counter << '\n';
            ...
            test1 = orientation3d(x0, x1, x2, x3);
            test2 = orient3d(x0, x1, x2, x3);
            if (test1 > 0 && test2 < 0 || test1 < 0 && test2 > 0) {
                std::cout << "TEST MISMATCH!\n";
                std::getchar();
            }
...
//                static int counter_24 = 0;
//                counter_24++;
//                std::cout << "CURRENT COUNTER 24 = " << counter_24 << '\n';
//                std::getchar();
                return 0;
            }
            if(!same_sign(*alpha3, *alpha4)) {
//                static int counter_34 = 0;
//                counter_34++;
//                std::cout << "CURRENT COUNTER 34 = " << counter_34 << '\n';
//                std::getchar();
                return 0;
            }
            sum1=*alpha0+*alpha1;
...
//                static int counter_deg = 0;
//                counter_deg++;
//                std::cout << "DEGENERATE = " << counter_deg << '\n';
//                std::getchar();
...
simplex_intersection_time3d(int k,
                            ...
                            const double* x0, double time0,
                            const double* x1, double time1,
                            const double* x2, double time2,
                            const double* x3, double time3,
                            const double* x4, double time4,
#else if
