...
-- |
-- | Source: leancomfy/lean/Lattice/Utils/Icons.lean
...
getLayerTypeIcon :: String -> String
getLayerTypeIcon = case _ of
  "image" -> "PhImage"
  "video" -> "PhFilmStrip"
  "text" -> "PhTextT"
  "solid" -> "PhSquare"
...
getAssetTypeIcon :: String -> String
getAssetTypeIcon = case _ of
...
getEffectCategoryIcon :: String -> String
getEffectCategoryIcon = case _ of
  "blur" -> "PhCircleHalf"
  "color" -> "PhPalette"
  "distort" -> "PhWaveSine"
  "generate" -> "PhSparkle"
...
getStemTypeIcon :: String -> String
getStemTypeIcon = case _ of
  "vocals" -> "PhMicrophone"
  "drums" -> "PhDrum"
  "bass" -> "PhWaveSquare"
  "other" -> "PhMusicNote"
