...
**Purpose**: This is the authoritative specification for building a professional-grade motion graphics compositor as an embedded ComfyUI extension. This document is designed to be handed directly to Claude Code or any developer for implementation.
