          ...
          in
            if frame <= keyframeFrame firstKf
              ...
              let
                ...
                interpX = safeLerpD (position2DOr3DX pos1) (position2DOr3DX pos2) interpolatedT
                interpY = safeLerpD (position2DOr3DY pos1) (position2DOr3DY pos2) interpolatedT
                interpZ = case (position2DOr3DZ pos1, position2DOr3DZ pos2) of
                  (Just z1, Just z2) -> Just (safeLerpD z1 z2 interpolatedT)
