...
{- |
Module      : Straylight.Script.Nvidia.Wheel
...
import qualified Straylight.Script.Nvidia.Wheel as Wheel
import qualified Straylight.Script.Nvidia.Versions as V
...
import Straylight.Script.Nvidia.Versions (Platform (..))
