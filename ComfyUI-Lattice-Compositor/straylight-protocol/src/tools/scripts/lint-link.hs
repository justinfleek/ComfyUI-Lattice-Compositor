...
{- |
Symlink straylight-naught lint configs to current directory.
...
copying files. This means configs auto-update when straylight-naught is updated,
but requires the Nix store to be accessible.

The configs-dir argument is the path to the straylight-naught configs directory,
...
main = do
    ...
    case args of
        ...
        _ -> do
            ...
            putStrLn "  configs-dir: path to straylight-naught lint configs directory"
            exitFailure

runLink :: FilePath -> IO ()
runLink configsDir = do
    putStrLn ":: Symlinking straylight-naught lint configs"
