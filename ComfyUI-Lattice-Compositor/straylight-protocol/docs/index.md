...
**Straylight.Script** - Haskell scripts instead of bash. `Straylight.Script` wraps Shelly with Turtle ergonomics. 32 scripts for containers, VMs, GPU passthrough.
