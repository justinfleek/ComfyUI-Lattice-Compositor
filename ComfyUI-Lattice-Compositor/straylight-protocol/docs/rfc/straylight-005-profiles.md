...
```bash
# Edit a file
vim nix/scripts/Straylight/Script/Config.hs
...
- [ℵ-006: Safe Bash](straylight-006-safe-bash.md) - Defines the bash/Haskell boundary
- [ℵ-004: Straylight.Script](straylight-004-typed-unix.md) - The Haskell scripting infrastructure
